...
const REF = "dist/concept/sentencepiece-tokenizer-explained/index.html"; // 参考页（已构建产物里的一篇真实文章页）
const SEG = "concept";
const DEFAULT_OG = "https://sentencepiece.org/og-image.png"; // 站点默认 og 图（绝对 URL，可为空串）
